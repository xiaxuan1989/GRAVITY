...
\]
依葫芦画瓢地寻找“更好”坐标系。在超前 Eddington 系中，时间对角项在 $r=2M$ 为零，为消除奇性，只能借由超前变换所产生的非零时空交叉项，但我们并不想要交叉项。可见，必须使 $T,X$ 坐标的时间对角项非零。回到 Schwarzschild 系。不妨先研究 $r>2M$。$v,u$ 从类光测地线族产生，注意 $t=\pm\left(r+2M\ln|r-2M|\right)+C$ 与 $t=\pm r_*$ 相差常数，因此内、外向族分别给出
\eq{
v=t+r_*,\quad u=t-r_*.
}
