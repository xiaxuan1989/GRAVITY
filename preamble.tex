...
\usepackage{ctex}
\setCJKmainfont[
    BoldFont = FandolSong-Bold,     % Fandol 宋体
    ItalicFont = FandolKai-Regular, % Fandol 楷体
...
\addbibresource{refs.bib} % bib 文件
\usepackage[
    hidelinks,          % 隐藏颜色
...
%=================== 数学相关 ===================
\usepackage{isomath}                       % ISO 规范的数学字体和符号
\usepackage{physics}                       % 物理学常用符号和导数简写命令
\usepackage{mathtools,nccmath}             % amsmath的扩展和改进，增强数学排版能力
\usepackage{mathtools}                     % 增强 amsmath 提供的数学排版能力
