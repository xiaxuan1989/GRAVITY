...
\newcommand\DrawArcThreeD[6][\AngleGamma]{
    ...
    \draw [color={rgb, 255:red, 74; green, 144; blue, 226},current plane][line width=0.7] (#2, 0) arc (0:\cVar:#2);
}
...
\node[inner sep=0pt] (globe) at (0,0){\includegraphics[width=.8\textwidth]{Europe-Blank-globe.png}}; 
\def\R{6.05} % 切面半径 %地球 6.05
\def\AngleGamma{51.36} % 极点倾斜角 
...
\DrawArcThreeD{\R}{-174.5}{40.6}{16}{40}; 
\node[above=4pt] at (N) {$\mathbf{N}$}; %地球 2pt
%\node[below=7pt] at (S) {$\mathbf{S}$};
